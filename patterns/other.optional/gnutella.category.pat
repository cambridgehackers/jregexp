...
# GNUTELLA.CATEGORY
(gnd[\x01\x02]?.?.?\x01|gnutella\x20connect/[012]\.[0-9]\x0d\x0a|get\x20/uri-res/n2r\?urn:sha1:|get\x20/[\x09-\x0d\x20-~]*user-agent:\x20(gtk-gnutella|bearshare|mactella|gnucleus|gnotella|limewire|imesh)|get\x20/[\x09-\x0d\x20-~]*content-type:\x20application/x-gnutella-packets|giv\x20[0-9]*:[0-9a-f]*/|queue\x20[0-9a-f]*\x20[1-9][0-9]?[0-9]?\.[1-9][0-9]?[0-9]?\.[1-9][0-9]?[0-9]?\.[1-9][0-9]?[0-9]?:[1-9][0-9]?[0-9]?[0-9]?|gnutella[\x09-\x0d\x20-~]*content-type:\x20application/x-gnutella|..................lime)
