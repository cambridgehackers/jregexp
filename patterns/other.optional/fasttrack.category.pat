...
# FASTTRACK.CATGORY
get\x20(/.download/[\x20-~]*|/.supernode[\x20-~]|/.status[\x20-~]|/.network[\x20-~]*|/.files|/.hash=[0-9a-f]*/[\x20-~]*)\x20http/1.1|user-agent:\x20kazaa|x-kazaa(-username|-network|-ip|-supernodeip|-xferid|-xferuid|tag)|give\x20[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]?[0-9]?[0-9]?
